...
### Work Experience
Print Media Assistant @ Northeastern Oakland Makerspaces | September 2025 - Present 
- Efficiently managed and holds student safety orientations
...
Co-developed the problem statement and evaluative criteria for creating an accessible, compact game system.

Ideated multiple game concepts (Flappy Bird variants, rhythm games, motion-based interactions) within kit constraints.

Produced design sketches, component diagrams, pseudocode, and prototype logic.

Built physical prototypes using laser-cut cardboard, LEDs, buttons, LCD display modules, and breadboard wiring.

Maintained the full Engineering Design Notebook, recording brainstorming, challenges, meeting minutes, and testing plans.

Skills Used

Circuit Prototyping • Microcontroller Programming • Team Engineering • Rapid Prototyping • Design Documentation
